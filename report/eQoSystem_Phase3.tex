...
We report negative results alongside positive ones throughout, because several of our own hypotheses failed measurement and the failures are informative. Everything below regenerates from one command at seed~42.
...
\midrule
\multicolumn{6}{@{}l@{}}{\footnotesize 51 jobs per run; design uses 50 integer variables against 104 binary equivalents; 142~s classical wall-clock.}\\
\bottomrule\end{tabular}\end{table}
